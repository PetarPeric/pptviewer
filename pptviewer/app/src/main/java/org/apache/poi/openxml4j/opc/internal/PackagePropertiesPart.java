...
public final class PackagePropertiesPart extends PackagePart implements
	 ...
	 *
	 * [petar: petar values for this property might include: Resume, Letter,
	 ...
	 * navigation of a large set of documents. end petar]
	 */
	 ...
	 *
	 * [petar: Values might include "Draft", "Reviewed", and "Final". end
	 * petar]
	 */
	 ...
	 * intended audience.
	 *
	 * [petar: Values might include "Whitepaper", "Security Bulletin", and
	 * "Exam". end petar] [Note: This property is distinct from MIME content
	 ...
	 *
	 * [petar: Values might include an abstract, table of contents, reference
	 ...
	 *
	 * [petar: A name, email address, or employee ID. end petar] It is
	 ...
	 * The revision number.
	 *
	 * [petar: This value might indicate the number of saves or revisions,
	 * provided the application updates it after each revision. end petar]
	 */
